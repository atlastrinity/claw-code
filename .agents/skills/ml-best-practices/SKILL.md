...
description: "CRITICAL RULE: You MUST use this skill whenever the task involves any machine learning tasks or data analysis (Clustering, Classification, Regression, Forecasting, etc.)."
license: Apache-2.0
metadata:
  version: v1
  publisher: google
