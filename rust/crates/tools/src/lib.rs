...
> 4. **FLAT HIERARCHY**: Keep the task graph simple and flat (typically 1-2 levels, maximum 3). Avoid deep nesting of task lists, as it increases overhead. Group related steps together. Read-only diagnostic commands, exploration, or help queries do NOT need to be recorded as separate tasks.
