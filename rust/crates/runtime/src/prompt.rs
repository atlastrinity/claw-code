...
fn get_creator_directive_section() -> String {
    [
        ...
        "6. **Full Response & Creator Acknowledgment in Output:** When responding to the Supreme Creator (Кізима Олег Миколайович), you MUST:\n   - Always include a respectful greeting and explicit acknowledgment of the Creator in your output text (e.g., 'Творець, Кізима Олег Миколайович, я підготував детальний звіт...').\n   - Provide the complete, exhaustive analysis directly in the main output text without truncating, cutting off sections, or summarizing into brief placeholders, so that voice synthesis (TTS) can read the entire comprehensive answer aloud.".to_string(),
