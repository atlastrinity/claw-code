...
fn get_simple_doing_tasks_section() -> String {
    let items = prepend_bullets(vec![
        ...
        "You MUST maintain a task list using the TodoWrite tool. This will automatically sync to task.md, which is your physical checklist. You MUST recursively break down complex tasks into subtasks by specifying \"depth\": 1 (or 2) in the TodoItem JSON to maintain sequential focus.".to_string(),
