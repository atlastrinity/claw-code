...
pub use error::{ApiError, ApiErrorInfo};
pub use http_client::{
...
pub use providers::{
    ...
    metadata_for_model, model_family_identity_for, model_family_identity_for_kind, model_token_limit, provider_diagnostics_for_model,
