...
- **Entitlements File**: `Config/ClawController.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/ClawController.entitlements`:
...
3. **Build and test**: Use standard tools to build and run tests
4. **Run on simulator**: Deploy to simulator for manual testing
5. **UI automation**: Use standard UI testing frameworks
